...
def createMovie(movieid=None):
    try:
        ...
        if moviename and moviegenre and language and director and request.method == 'POST':
            ...
            try:
                ...
                return jsonify("Movie already exists with the same name")
...
def viewMovies():
    try:
        ...
        cursor.execute("SELECT movies.movieid, genre.genre, movies.director, movies.language FROM movies JOIN genre ON movies.moviegenre = genre.genreid;")
